"""
╔══════════════════════════════════════════════════════════════════════════════╗
║         AURUM·AI  —  gold_miner_trainer.py  (v9)                           ║
║                                                                              ║
...
# seed=83959 ic=0.498120 dir_acc=0.640152 v10
...
CFG = {
    # Data
    # v9: added macro regime features (dollar trend, real rates, gold secular)
    # Start date kept at 2013 — 2008 extension tested separately since GFC
    # data is noisy and may hurt generalisation on modern regimes.
    "target":          "GDX",
    ...
    "min_train_years": 2,                   # 2008 start gives ample warmup
