...
CFG = {
    ...
    "target":          "SHEL",
    "start_date":      "2016-03-01",  # post-BG Group merger (Feb 2016) — single coherent Shell entity
...
TICKERS = [
    "SHEL",         # target — Shell PLC (UK, no US estate tax)
    "XLE",          # Energy Select Sector SPDR (kept as macro feature)
